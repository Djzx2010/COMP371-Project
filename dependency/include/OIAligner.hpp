...
public:
    ...
    (
        OIDevice* pDevice,
        OIAbstractDataFrame* depthFrame,
        byte* alignedDataBuf,
        int len
    );
    ...
    // transform a point from one 3D coordinate to another
...
private:
    ...
    void alignImages
    (
            const openiss::Intrinsic &depthIntrinsic,
            const openiss::Intrinsic &colorIntrinsic,
