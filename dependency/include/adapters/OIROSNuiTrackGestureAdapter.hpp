...
#ifndef OPENISS_ROS_NUITRACK_GESTURE_ADAPTER_H
#define OPENISS_ROS_NUITRACK_GESTURE_ADAPTER_H
...
namespace openiss
{
    ...
    class OIROSNuiTrackGestureAdapter : public OIGestureTracker
    {
    public:
        ~OIROSNuiTrackGestureAdapter() override = default;
...
#endif // OPENISS_ROS_NUITRACK_GESTURE_ADAPTER_H
